...
added or removed through a simple web page. No knowledge of SQL or Python
knowledge needed.
...
You need Python 3 installed (as always). Then, in this folder:
...
- **<http://localhost:5000>** — the practice app (what you demo to judges)
